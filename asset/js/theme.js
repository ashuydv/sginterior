(function ($) {
  ...
  var detectBrowser = {
    isOpera:
      ...
      !!window.opera ||
      navigator.userAgent.indexOf(" OPR/") >= 0, // eslint-disable-line
          ...
          $(sliderElementSelector).each(function (index, item) {
            revapi = tpj(item)
              ...
              .revolution({
                ...
                sliderLayout: sliderElement.classList.contains(
                  "revolution-slider__slider_autoheight"
                )
                  ? null
                  : "fullscreen",
                dottedOverlay: "none",
  ...
  (function () {
    ...
    function setNavColor(index) {
      if (
        $($(".full-screen-block__slide")[index - 1]).hasClass(
  ...
  (function () {
    ...
    button.on("click", function () {
      ...
      button.toggleClass(
        "header__menu-button_burger",
        !button.hasClass("header__menu-button_cross")
      );
    ...
    if ($(".header_fixed").length) {
      ...
      var nav_offset_top = headerElement.classList.contains("header_offset")
        ? window.innerHeight
      ...
      $(window).scroll(function () {
        ...
        if (scroll >= nav_offset_top) {
          ...
          headerContainer.style.top = "-".concat(
  ...
  (function () {
    ...
    if (grid.length) {
      ...
      filterBtn.on("click", function () {
        $(".masonry__secondary-filter-button_active").removeClass(
        ...
        var filterFns = {
          category: function category() {
            var categories = this.querySelector("[data-filters]")
        ...
        var filterValue =
          filterBy === "*" || filterBy === "All" || filterBy === "all"
            ? "*"
            : filterFns.category;
        $grid.isotope({
          filter: filterValue,
      ...
      tabButton.on("click", function () {
        ...
        $(".masonry__secondary-filters_active")
          .removeClass("masonry__secondary-filters_active")
          .css({
            position: "absolute",
          })
          .fadeOut(300);
        $(
          ".masonry__secondary-filters[data-tab-group=".concat(
            this.getAttribute("data-tab-button"),
            "]"
          )
        );
        $(
          ...
          .addClass("masonry__secondary-filters_active")
          .css({
            position: "relative",
          })
          .fadeIn(300);
  ...
  (function () {
    ...
    var filterButtonElements = _toConsumableArray(
      document.querySelectorAll(".projects-block__filter-link")
    );
    var buttonPrevElement = document.querySelector(
      ".projects-block__control_prev"
    );
    var buttonNextElement = document.querySelector(
      ".projects-block__control_next"
    );
    var activeFilterClass = "link_active";
    var sliderElement = $(".projects-block__slider");

    if (sliderElement.length) {
      var sliderElements = _toConsumableArray(
        document.querySelectorAll(".projects-block__slider .swiper-slide")
      );
      ...
      var slidesElements = _toConsumableArray(
        document.querySelectorAll(".projects-block .swiper-slide")
      );
          ...
          tl.to(sliderElement, 0.3, {
            ...
            .call(function () {
              ...
              sliderElements.filter(function (item) {
                if (
                  item.getAttribute("data-filter").indexOf(filter) >= 0 ||
                  filter === "all"
                ) {
  ...
  //payment-slider
  (function () {
    var sliderWrapper = $(".payments-slider");

    if (sliderWrapper.length) {
      $(sliderWrapper).each(function (index, item) {
        var sliderElement = $(item).find(".payments-slider__slider");
        var buttonPrevElement = $(item).find(".payments-slider__control_prev");
        var buttonNextElement = $(item).find(".payments-slider__control_next");
  ...
  (function () {
    var buttonPrevElement = document.querySelector(
      ".payments-block__control_prev"
    );
    var buttonNextElement = document.querySelector(
      ".payments-block__control_next"
    );
    var sliderElement = $(".payments-block__slider");
          ...
          on: {
            slideChange: function slideChange() {
              setTimeout(function () {
                ...
                $(slideButton[swiper.activeIndex]).addClass(
  ...
  (function () {
    ...
    var filterButtonElements = document.querySelectorAll(
    ...
    if (sliderElement.length) {
      var sliderElements = _toConsumableArray(
        document.querySelectorAll(".zoom-slider__slider .swiper-slide")
      );

      var thumbsElements = _toConsumableArray(
        document.querySelectorAll(".zoom-slider__buttons .swiper-slide")
      );
      ...
      filterButtonElements.forEach(function (button) {
        button.addEventListener("click", function (e) {
          ...
          button.classList.add(activeFilterClass);
          var tl = new TimelineLite();
          tl.to([sliderElement, thumbsElement], 0.3, {
            opacity: 0,
          })
            .call(function () {
            ...
            .to([sliderElement, thumbsElement], 0.3, {
              opacity: 1,
              clearProps: "opacity",
            });
        });
